...
public class GeneratedTest {
    public static void main(String[] args) {
        ...
        actions.sendKeys("Soil ready?").perform();   // into element created in step 11
        actions.doubleClick(cell).perform();   // element created in step 18
        actions.sendKeys("Rain expected?").perform();   // into element created in step 18
        actions.doubleClick(cell).perform();   // element created in step 19
        actions.sendKeys("Test the soil").perform();   // into element created in step 19
        actions.doubleClick(cell).perform();   // element created in step 26
        actions.sendKeys("Sow the seed").perform();   // into element created in step 26
        actions.doubleClick(cell).perform();   // element created in step 35
        actions.sendKeys("Crop stored").perform();   // into element created in step 35
        ...
        actions.sendKeys("Ready").perform();   // into connector_from_step11_to_step18
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.doubleClick(cell).perform();   // connector_from_step11_to_step35
        actions.sendKeys("Too dry").perform();   // into connector_from_step11_to_step35
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.doubleClick(cell).perform();   // connector_from_step18_to_step19
        actions.sendKeys("Rain").perform();   // into connector_from_step18_to_step19
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.doubleClick(cell).perform();   // connector_from_step18_to_step35
        actions.sendKeys("Dry").perform();   // into connector_from_step18_to_step35
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
