...
public class GeneratedTest {
    public static void main(String[] args) {
        ...
        actions.sendKeys("Read the manual").perform();   // into element created in step 9
        actions.doubleClick(cell).perform();   // element created in step 14
        actions.sendKeys("Check the socket").perform();   // into element created in step 14
        actions.doubleClick(cell).perform();   // element created in step 17
        actions.sendKeys("Plugged in?").perform();   // into element created in step 17
        actions.doubleClick(cell).perform();   // element created in step 18
        actions.sendKeys("Plug it in").perform();   // into element created in step 18
        actions.doubleClick(cell).perform();   // element created in step 28
        actions.sendKeys("Replace the bulb").perform();   // into element created in step 28
        actions.doubleClick(cell).perform();   // element created in step 40
        actions.sendKeys("Lamp works").perform();   // into element created in step 40
        ...
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.doubleClick(cell).perform();   // connector_from_step17_to_step40
        actions.sendKeys("No").perform();   // into connector_from_step17_to_step40
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
