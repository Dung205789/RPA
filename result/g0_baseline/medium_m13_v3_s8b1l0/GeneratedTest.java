...
public class GeneratedTest {
    public static void main(String[] args) {
        ...
        actions.sendKeys("Read the manual").perform();   // into element created in step 11
        ...
        actions.doubleClick(cell).perform();   // element created in step 25
        actions.sendKeys("Replace the bulb").perform();   // into element created in step 25
        actions.doubleClick(cell).perform();   // element created in step 34
        actions.sendKeys("Test the switch").perform();   // into element created in step 34
        actions.doubleClick(cell).perform();   // element created in step 44
        actions.sendKeys("Lamp works").perform();   // into element created in step 44
        ...
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.doubleClick(cell).perform();   // connector_from_step10_to_step18
        actions.sendKeys("No").perform();   // into connector_from_step10_to_step18
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
