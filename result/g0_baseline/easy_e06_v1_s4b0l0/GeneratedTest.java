...
public class GeneratedTest {
    public static void main(String[] args) {
        ...
        actions.sendKeys("Read the forecast").perform();   // into element created in step 5
        actions.doubleClick(cell).perform();   // element created in step 6
        actions.sendKeys("Test the soil").perform();   // into element created in step 6
        actions.doubleClick(cell).perform();   // element created in step 9
        actions.sendKeys("Crop stored").perform();   // into element created in step 9
