...
public class GeneratedTest {
    public static void main(String[] args) {
        ...
        actions.sendKeys("Plugged in?").perform();   // into element created in step 15
        actions.doubleClick(cell).perform();   // element created in step 26
        actions.sendKeys("Check the socket").perform();   // into element created in step 26
        actions.doubleClick(cell).perform();   // element created in step 27
        actions.sendKeys("Plug it in").perform();   // into element created in step 27
        actions.doubleClick(cell).perform();   // element created in step 30
        actions.sendKeys("Read the manual").perform();   // into element created in step 30
        actions.doubleClick(cell).perform();   // element created in step 35
        actions.sendKeys("Lamp works").perform();   // into element created in step 35
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.doubleClick(cell).perform();   // connector_from_step15_to_step26
        actions.sendKeys("Yes").perform();   // into connector_from_step15_to_step26
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.doubleClick(cell).perform();   // connector_from_step15_to_step35
        actions.sendKeys("No").perform();   // into connector_from_step15_to_step35
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
        actions.clickAndHold(src).moveToElement(dst).release().perform();
