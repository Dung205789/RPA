...
public class GeneratedTest {
    public static void main(String[] args) {
        ...
        actions.sendKeys("List changed files").perform();   // into element created in step 5
        actions.doubleClick(cell).perform();   // element created in step 6
        actions.sendKeys("Compress the archive").perform();   // into element created in step 6
        actions.doubleClick(cell).perform();   // element created in step 9
        actions.sendKeys("Backup complete").perform();   // into element created in step 9
