...
public class GeneratedTest {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 15; i++) { actions.keyDown(Keys.SHIFT).sendKeys(Keys.ARROW_UP).keyUp(Keys.SHIFT).perform(); }
        // click D:\SVG_Agent\documents\RPA_drawio\shape_icons\document.png (a, score 1.00)
        // click D:\SVG_Agent\documents\RPA_drawio\shape_icons\rectangle.png (a, score 1.00)
